...
const loadForms = async () => {
  ...
  try {
    ...
    console.log(`Loaded ${forms.value.length} forms for user ${user.value.email}`)
  } catch (error) {
    console.error('Error loading forms:', error)
    alert('Error loading forms. Please refresh the page.')
  } finally {
    loading.value = false
  }
}
